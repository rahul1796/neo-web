def create_report(batch_id, user_id, user_role_id, status, customer, project, sub_project, region, center, center_type,BU,BatchCodes, Planned_actual, StartFromDate, StartToDate, EndFromDate, EndToDate, file_name, customer_status):
    ...
    try:
        ...
        values = (batch_id,0,1000000,'','','',user_id,user_role_id, status, customer, project, sub_project, region, center, center_type, BU,'',BatchCodes, Planned_actual, StartFromDate, StartToDate, EndFromDate, EndToDate, customer_status) #
        ...
        'Center_Location','Center_State','Ojt_Start_Date','Ojt_End_Date','Course_Name','Customer_Status', 'Customer_Name',
        ...
        'Center_Location','Center_State','OJT_Start_Date','OJT_End_Date','Course_Name','Customer Status', 'Customer_Name',
