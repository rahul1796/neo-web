                        ...
                        if( count> 0)
                        {
                            ...
                            {   var txt=''
                                ...
                                if(!($("#hdn_home_user_role_id ").val() == "25"  & data.Assessments[i].Assessment_Agency_Id==1))
                                {
                                    ...
                                    if ((data.Assessments[i].Mobilization_Type==4 & ($("#hdn_home_user_role_id ").val() == "5" || $("#hdn_home_user_role_id ").val() == "1" ))||(((data.Assessments[i].Assessment_Stage_Id==3)||(data.Assessments[i].Assessment_Stage_Id==4)) & ($('#hdn_home_user_role_id').val()!='5'||(data.Assessments[i].Assessment_Agency_Id==1 & ($('#hdn_home_user_role_id').val()=='5'||$('#hdn_home_user_role_id').val()=='38') ))  & $('#hdn_home_user_role_id').val()!='14'))
                                    {
                                        if( !($("#hdn_home_user_role_id ").val() == "7"  & (data.Assessments[i].Assessment_Types_Name=="Final Summative" || data.Assessments[i].Assessment_Types_Name=="Summative") ))
