        ...
        "columns": [
            ...
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 0 + '\' )"  style="color:blue;cursor:pointer" >' + row.Passed + '</a>';
                    }
                    return varButtons;
                    return row.Passed;
                    }
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 1 + '\' )"  style="color:blue;cursor:pointer" >' + row.Requested_Printing + '</a>';
                    }
                    return varButtons;
            ...
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 2 + '\' )"  style="color:blue;cursor:pointer" >' + row.Sent_Printing + '</a>';
                    }
                    return varButtons;
            ...
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 3 + '\' )"  style="color:blue;cursor:pointer" >' + row.Sent_Center + '</a>';
                    }
                    return varButtons;
            ...
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 4 + '\' )"  style="color:blue;cursor:pointer" >' + row.Received_Center + '</a>';
                    }
                    return varButtons;
            ...
            },
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 5 + '\' )"  style="color:blue;cursor:pointer" >' + row.Planned_Distribution + '</a>';
                    }
                    return varButtons;
           ...
           
            {
                "data": function (row, type, val, meta) {
                    ...
                    {   
                        varButtons += '<a onclick="GetPassedCandidates(\'' + row.Batch_Id + '\',\'' + 6 + '\' )"  style="color:blue;cursor:pointer" >' + row.Distributed_Count + '</a>';
                    }
                    return varButtons;
...
function GetPassedCandidates(BatchId,Stage){   
    ...
    var URL=$('#hdn_web_url').val()+ "/ALLCandidatesBasedOnCertifiactionStage?batch_id="+BatchId+"&stgae_id="+Stage;
    $.ajax({
        type:"GET",
        url:URL,      
        async:false,
                ...
                if (data.Candidates != null){
                    ...
                    {   
                        ...
                        {   
                            ...
                            if(data.Candidates[i].Certificate_Flag==0) 
                                txt+='<input id="addedchk" name="checkcase" type="checkbox" value="'+data.Candidates[i].Intervention_Value+'" >';
                            else{
                                 txt+='<input id="addedchk" name="checkcase" type="checkbox" value="'+data.Candidates[i].Intervention_Value+'" >';
                                }
