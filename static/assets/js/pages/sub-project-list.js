...
function UploadFileData()
{
    ...
    else
    {
        ...
        else
        {
            ...
            var file_path=$('#hdn_AWS_S3_path').val()+"bulk_upload/project_planner/" + $('#hdn_home_user_id').val() + '_' + d.getFullYear()+'_'+d.getMonth()+'_'+d.getDate()+'_'+d.getHours()*60+d.getMinutes() + '_' + file.name; 
